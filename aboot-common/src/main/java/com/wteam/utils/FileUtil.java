...
public class FileUtil extends cn.hutool.core.io.FileUtil {
     ...
     * @param pattern 日期格式
     */
    private static void write2Sheet(HSSFSheet sheet,List<Map<String, Object>> list,
        ...
        while (it1.hasNext()){
            ...
            HSSFRichTextString text = new HSSFRichTextString(it1.next());
    ...
    // 自适应宽度(中文支持)
    private static void setSizeColumn(HSSFSheet sheet, int rowsSize) {
